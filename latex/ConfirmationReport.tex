...
Table~\ref{table:yields} to the decay modes sensitive to $\phi_3$ has been
performed, and the results are shown in Table ??. The number of GLW mode
...
PDG,~\cite{PDG2018}. The scale factor used to calculate event numbers in the ADS mode is
$R_{ADS}\approx 0.015$, which contains the phase information needed for
transforming from the Cabibbo favoured to the doubly-Cabibbo suppressed mode.
The number of ADS mode events measure by the BaBar Collabortation in
2004,~\cite{BaBarADS}, is also given.
