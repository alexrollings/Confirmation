...
The physics decays that fall within these categories are listed in Table ??. There are also fit components within each neutral mode to account for
...
in the $D\pi^0$ final state are also given the freedom to float. The yields
taken from these fits are listed in Table ??.
...
\begin{itemize}
\item Table with yields. Label background categories
