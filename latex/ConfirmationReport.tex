...
\noindent
\\
	The decay $B^{\pm} \rightarrow D^{*}h^{\pm}$, where $D^{*} \rightarrow
[K^{\pm}\pi^{\pm}]_D$ $\pi^{0}\text{/}\gamma$ and $h=\pi/K$, is studied using
...
events is reported and an extrapolation of event yields to the modes sensitive
to $\phi_3$ is made. 
% And measurement of ratio
\end{abstract}
\vfill
\end{nolinenumbers}
\end{titlepage}
...
The physics decays that fall within these categories are listed in
Tables~\ref{table:yieldsPi0} and~\ref{table:yieldsGamma}. There are also fit components within each neutral
mode to account for cross-feed from the alternative $D^*$ final state. 
...
The yields taken from these fits are listed in Table~\ref{table:yieldsPi0} for
the $D^*\rightarrow D\pi^0$ mode and Table~\ref{table:yieldsGamma} for the
$D^*\rightarrow D\gamma$ mode.
...
\section{Results and Ongoing Work} \label{sec:results}

\begin{table}[]
\resizebox{\textwidth}{!}{%
\begin{tabular}{|c|c|c|c|c|c|}
\hline
\multicolumn{1}{|c|}{\multirow{2}{*}{\textbf{Decay Mode}}} & \multirow{2}{*}{\textbf{Category}} & \multicolumn{2}{c|}{\textbf{Run1 Yield (3 fb$^{-1}$)}} & \multicolumn{2}{c|}{\textbf{Run1 and Run2 Yield (6.6 fb$^{-1}$)}} \\ \cline{3-6} 
\multicolumn{1}{|c|}{} &  & \multicolumn{1}{c|}{$B^{\pm}\rightarrow D^*\pi^{\pm}$} &
\multicolumn{1}{c|}{$B^{\pm}\rightarrow D^*K^{\pm}$} &
\multicolumn{1}{c|}{$B^{\pm}\rightarrow D^*\pi^{\pm}$} &
\multicolumn{1}{c|}{$B^{\pm}\rightarrow D^*K^{\pm}$} \\ \hline
$B^{\pm}\rightarrow (D^{*0}\rightarrow [K^{\pm}\pi^{\mp}]_D^0 \pi^0)\pi^{\pm}$ & 0 &  &  &  &  \\ \hline
$B^{\pm}\rightarrow (D^{*0}\rightarrow [K^{\pm}\pi^{\mp}]_D^0 \gamma)\pi^{\pm}$ & 4 &  &  &  &  \\ \hline
$B^{\pm}\rightarrow [K^{\pm}\pi^{\mp}]_D^0\pi^{\pm}$ & 2 &  &  &  &  \\ \hline
$B^{\pm}\rightarrow [K^{\pm}\pi^{\mp}]_D^0\rho^{\pm}$ \& & \multirow{2}{*}{3} & \multirow{2}{*}{} & \multirow{2}{*}{} & \multirow{2}{*}{} & \multirow{2}{*}{} \\ 
$B^{0}\rightarrow (D^{*\pm}\rightarrow [K^{\pm}\pi^{\mp}]_D^0 \pi^{\pm})\pi^{\mp}$ &  &  &  &  &  \\ \hline
$B^{\pm}\rightarrow (D^{*0}\rightarrow [K^{\pm}\pi^{\mp}]_D^0 \pi^0)\rho^{\pm}$ & 1 &  &  &  &  \\ \hline
$B^{\pm}\rightarrow (D^{*0}\rightarrow [K^{\pm}\pi^{\mp}]_D^0 \gamma)\rho^{\pm}$ & 1 &  &  &  &  \\ \hline
\end{tabular}%
} \caption{\small{Yields for the $D\pi^0$ final state, extracted from 2D fits
for Run1, then Run1 and Run2 data for all components. Categories are as
follows: 0 for signal, 1 for partially-reconstructed backgrounds, 2 for
over-reconstructed backgrounds, 3 for mis-reconstructed backgrounds and 4 for
cross-feed from the $D\gamma$ signal.}} \label{table:yieldsPi0}
\end{table}
...
\multicolumn{1}{c|}{$B^{\pm}\rightarrow D^*\pi^{\pm}$} &
\multicolumn{1}{c|}{$B^{\pm}\rightarrow D^*K^{\pm}$} \\ \hline
$B^{\pm}\rightarrow (D^{*0}\rightarrow [K^{\pm}\pi^{\mp}]_D^0 \pi^0)\pi^{\pm}$ & 4 &  &  &  &  \\ \hline
$B^{\pm}\rightarrow (D^{*0}\rightarrow [K^{\pm}\pi^{\mp}]_D^0 \gamma)\pi^{\pm}$ & 0 &  &  &  &  \\ \hline
$B^{\pm}\rightarrow [K^{\pm}\pi^{\mp}]_D^0\pi^{\pm}$ & 2 &  &  &  &  \\ \hline
$B^{\pm}\rightarrow [K^{\pm}\pi^{\mp}]_D^0\rho^{\pm}$ \& & \multirow{2}{*}{3} & \multirow{2}{*}{} & \multirow{2}{*}{} & \multirow{2}{*}{} & \multirow{2}{*}{} \\ 
$B^{0}\rightarrow (D^{*\pm}\rightarrow [K^{\pm}\pi^{\mp}]_D^0 \pi^{\pm})\pi^{\mp}$ &  &  &  &  &  \\ \hline
$B^{\pm}\rightarrow (D^{*0}\rightarrow [K^{\pm}\pi^{\mp}]_D^0 \pi^0)\rho^{\pm}$ & 1 &  &  &  &  \\ \hline
$B^{\pm}\rightarrow (D^{*0}\rightarrow [K^{\pm}\pi^{\mp}]_D^0 \gamma)\rho^{\pm}$ & 1 &  &  &  &  \\ \hline
\end{tabular}%
} \caption{\small{Yields for the $D\gamma$ final state, extracted from 2D fits
for Run1, then Run1 and Run2 data for all components. Categories are as
follows: 0 for signal, 1 for partially-reconstructed backgrounds, 2 for
over-reconstructed backgrounds, 3 for mis-reconstructed backgrounds and 4 for
cross-feed from the $D\pi^0$ signal.}} \label{table:yieldsGamma}
\end{table}
...
\item Validation: give R D*K/D*pi and show consistent with part reco and PDG. 
