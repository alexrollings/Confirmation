...
% matter-antimatter asymmetry we see in the observable Universe.  
...
\begin{figure}[H]
  \centering \includegraphics[width=1\textwidth]{figures/CKMGlobalFit}
...
\begin{figure}[H]
  \centering \includegraphics[width=0.8\textwidth]{figures/B2DstarKstar}
...
$f(\accentset{\brobor}{D}\phantom{})$:
  ...
  \end{equation}
\noindent 4 analogous charge conjugate equations can be written for the $B^{+}$
...
\begin{figure}[H]
  \centering \includegraphics[width=1\textwidth]{figures/B2DstKDiagram.png}
