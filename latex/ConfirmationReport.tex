...
topology of the type $B^{\pm}\rightarrow DK^{\pm}$, then a neutral particle
is combined with the $D$ meson to make a $B^{\pm}\rightarrow D^*K^{\pm}$
candidate.

The $D$ meson, reconstructed from two oppositely charged daughter particles, is
required to be within $\pm$25 MeV/c$^2$ of the nominal $D^0$ mass, which
corresponds to approximately three times the mass resolution. The charged pion
and kaon from the $B^{\pm}$ decay vertex are chosen to occupy the kinematic
range of the RICH detector, $5 < p < 100$ GeV/c and $0.5 < p_T < 10$ GeV/c. When
a neutral pion is present, it is required to lie within the asymmetric mass
window of $110 < m_{\pi^0} < 185$ MeV/c$^2$. A kinematic fit is performed to the
...
constrained to their own masses.
